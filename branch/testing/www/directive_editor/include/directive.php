...
?>
		...
		<td nowrap>&nbsp;&nbsp;<a onclick="javascript:if (confirm('<?php echo  Util::js_entities(_("Are you sure you want to delete all rules ?")); ?>')) { window.open('../include/utils.php?query=del_all_rule','right'); }" style="marging-left:20px; cursor:pointer" TITLE="<?php echo gettext("Delete all rules of this directive"); ?>"><img src="../../pixmaps/delete.gif" border="0"></img></a></td>
    	<td nowrap>&nbsp;&nbsp;<a TARGET="right" href="../include/utils.php?query=copy_directive&id=<?php echo $id ?>&directive_xml=<?php echo $xml_file?>" TITLE="<?php echo gettext("Copy this directive to a new"); ?>"><img src="../../pixmaps/copy.png" border="0"></img></a></td>

    ...
    <?php
		...
		<?php
            ...
            if (!$this->is_new()) {
                ...
                //removeRule button
                print '<td>';
                if ($this->level > 1) { print "<a onclick=\"javascript:if (confirm('" .  Util::js_entities(_("Are you sure you want to delete this rule ?")) . "')) { window.open('../include/utils.php?query=del_rule&id=" . $this->id . "','right'); }\" style=\"marging-left:20px; cursor:pointer\" TITLE=\"" . gettext("Delete this rule") . "\"><img src='../../pixmaps/delete-small.gif' border='0'></img></a>"; }
                print '</td>';
                //copy button
                print '<td>';

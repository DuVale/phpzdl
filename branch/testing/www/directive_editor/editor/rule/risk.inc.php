...
<input type="hidden" name="occurrence" id="occurrence" value="<?php echo ($rule->occurrence > 0) ? $rule->occurrence : 1 ?>"></input>
...
<input type="hidden" name="time_out" id="time_out" value="<?php echo $rule->time_out ?>"></input>
	<table class="transparent" width="100%">
		<tr>
			<th style="white-space: nowrap; padding: 5px;font-size:12px">

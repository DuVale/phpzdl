				...
				<tr>
					...
					<div style="overflow:auto;height:300px;width:500px;border:1px solid #EEEEEE">
						...
						<tr id="<?php echo $plugin->get_id() ?>;<?php echo strtolower($plugin->get_name()) ?>" class="plugin_line" style="display:block">
						    <td width="110" class="nobborder" bgcolor="<?php echo $color ?>"><a href="" onclick="document.getElementById('plugin_id').value='<?php echo $plugin->get_id() ?>';document.getElementById('type').value='<?php echo ($plugin_type == '2') ? "monitor" : "detector" ?>';rm_sids();wizard_next();init_sids(<?php echo $plugin->get_id() ?>,<?php echo ($plugin_type == '2') ? "true" : "false" ?>);return false;"><b><?php echo $plugin->get_name() ?></b></a></td>

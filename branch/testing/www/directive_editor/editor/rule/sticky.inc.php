...
<input type="hidden" name="sticky_different" id="sticky_different" value="<?php if ($rule->level > 1) echo $rule->sticky_different ?>"></input>
	<table class="transparent" width="100%">
		<!-- sticky different -->
		<tr>
			<th style="white-space: nowrap; padding: 5px;font-size:12px">
		...
		<tr><td class="center nobborder"><input type="button" value="None" onclick="document.getElementById('sticky_different').value = 'None';wizard_next();" style="width:80px<?php if ($rule->sticky_different == "None" || $rule->sticky_different == "Default") { ?>;background: url(../../../pixmaps/theme/bg_button_on2.gif) 50% 50% repeat-x !important<?php } ?>"></input></td></tr>

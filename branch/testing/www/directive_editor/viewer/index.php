...
list($alarms,$num_alarms) = Alarm::get_list3($conn,"","",0,"",0,5,null,null,"",$directive_id);
...
<tr><td style="border:0px;background-color:<?php echo $color?>"><a onclick="javascript:if (confirm('<?php
        echo  Util::js_entities(_("Are you sure you want to delete this category ?")) ?>')) { document.location.href='../include/utils.php?query=delete_category&id=<?php
...
<tr><td><a onclick="javascript:if (confirm('<?php
        echo  Util::js_entities(_("Are you sure you want to delete this group ?"));?>')) { document.location.href='../include/utils.php?query=delete_group&name=<?php
...
<li class="level1"><div class="li"> <strong><?php echo _("Sensor Name") ?></strong>: <?php echo _("You can use any Sensor name defined via web (<em>Assets -> Alienvault Components -> Sensors</em>).") ?></div> 
</li> 
<li class="level1"><div class="li"> <strong><?php echo _("Relative value") ?></strong>: <?php echo _("This is used to reference ip addresses from previous levels. This should be easier to understand using examples") ?> </div> 
<ul> 

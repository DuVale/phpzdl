			...
			if (typeof(items[0]) != 'undefined') {
				...
				$.ajax({
						...
						success: function(msg) {
							if(msg.match("ERROR_CANNOT")) alert("<?php echo Util::js_entities(_("Sorry, cannot delete this host because it belongs to a policy"))?>");
							else $("#flextable").flexReload();
						}
				});
			}
			else alert("<?php echo Util::js_entities(_("You must select a device"))?>");
		}

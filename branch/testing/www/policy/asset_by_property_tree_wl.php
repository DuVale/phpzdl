...
$m_perms  = array ("MenuMonitors", "MenuPolicy", "MenuReports");
$sm_perms = array ("MonitorsInventory", "PolicyHosts", "ReportsHostReport");
		...
		if( $cclass==$found[1] ) 
		{
			...
			foreach ($host_list as $host_data) 
			{
				if($j>=$from && $j<$to) 
				{
					...
					$buffer.= "{ ".$url." icon:'../../pixmaps/theme/host.png', title:'$title', tooltip:'$tooltip', h:700 },";
				}
				$j++;
			}
		}

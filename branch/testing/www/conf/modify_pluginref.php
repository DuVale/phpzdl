...
<head>
	...
	<script type="text/javascript">
		...
		function formsubmit () {
			...
			else alert ("<?php echo Util::js_entities(_('Must select Data Source/Event Type pair'))?>");
        }
...
<form name="frules" method="get">
	...
	<tr>
        <td class="nobborder" style="text-align:center;padding:20px"><?php echo _("Data Source Name")?>: 
			<select name="plugin_id1" onchange="load_sid(1,document.frules.plugin_id1.value);">
				<option value=""><?php echo _('Data Source Name')?>
				<?php
		...
		<td class="nobborder" style="text-align:center;padding:20px"><?php echo _('Reference Data Source Name')?>:
			<select name="plugin_id2" onchange="load_sid(2,document.frules.plugin_id2.value);">
				<option value=""><?php echo _('Select Reference Data Source Name')?>
				<?php
				foreach($plugin_list as $plugin) 
				{
					$id = $plugin->get_id();
	...
	<tr>
		...
		<td id="sid2" class="nobborder" style="text-align:center;padding:20px">
			...
			<?php echo _('Reference Event Type')?>:
			<select id="sidajax2" onchange="document.frules.plugin_sid2.value=this.value">
				<option value=""><?php echo _('Select Reference Event Type')?>
				<?php
				foreach($plugin_list as $plugin) 
				{
					?>

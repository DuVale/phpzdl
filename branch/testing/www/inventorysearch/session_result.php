...
for ($i = $start; $i < $to; $i++) {
	$host = $host_list[$i];
	if ($userfriendly) host_row_basic($host,$conn,$criterias,$has_criterias,$networks,$hosts_ips,$i,$icons);
	else host_row($host,$conn,$criterias,$has_criterias,$networks,$hosts_ips,$icons);
}
echo "'}\n";

...
<tr>
	...
	<td align="right"><div id="chart3" class="plot" style="width:300px;height:170px;cursor:hand" onclick="top.frames['topmenu'].location.href='../top.php?hmenu=<?php echo md5("Dashboards") ?>&smenu=<?php echo md5("Risk") ?>&url=control_panel%2Fglobal_score.php%3Fhmenu%3DRisk%26smenu%3DMetrics'"></div></a></td>
</tr>
</table>
</body>
</html>

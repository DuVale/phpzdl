...
if($conf->get_conf("backup_day")<=5){
    ...
    $_2Ago_interv='DATE_ADD(CURDATE(), INTERVAL -2 DAY)';
    //
    $_Week='INTERVAL -7 DAY';
    $_Week_div='/7';
    $_Week_interv='NOW()';
    //
    $_2Week='INTERVAL -14 DAY';
    $_2Week_div='/14';
    $_2Week_interv='NOW()';
    //
}
...
$tzc = Util::get_tzc();
$query = "SELECT * FROM 
(select count(*) as Today from alarm where convert_tz(alarm.timestamp,'+00:00','$tzc') > CURDATE()$sensor_where_ossim) as Today, 
(select count(*) as Yesterd from alarm where convert_tz(alarm.timestamp,'+00:00','$tzc') > DATE_ADD(CURDATE(), INTERVAL -1 DAY) and convert_tz(alarm.timestamp,'+00:00','$tzc') < CURDATE()$sensor_where_ossim) as Yesterd,
(select count(*)".$_2Ago_div." as 2DAgo from alarm where convert_tz(alarm.timestamp,'+00:00','$tzc') > DATE_ADD(CURDATE(), ".$_2Ago.") and convert_tz(alarm.timestamp,'+00:00','$tzc') < DATE_ADD(".$_2Ago_interv."$sensor_where_ossim, INTERVAL +1 DAY) ) as 2DAgo,
(select count(*)".$_Week_div." as Week from alarm where convert_tz(alarm.timestamp,'+00:00','$tzc') > DATE_ADD(CURDATE(), ".$_Week.") and convert_tz(alarm.timestamp,'+00:00','$tzc') < ".$_Week_interv."$sensor_where_ossim) as Week,
(select count(*)".$_2Week_div." as 2Weeks from alarm where convert_tz(alarm.timestamp,'+00:00','$tzc') > DATE_ADD(CURDATE(), ".$_2Week.") and convert_tz(alarm.timestamp,'+00:00','$tzc') < ".$_2Week_interv."$sensor_where_ossim) as 2Weeks ;";
//echo $query;
...
//
$alarm_urls = "'../top.php?hmenu=".md5("Incidents")."&smenu=".md5("Tickets")."&url=".urlencode("control_panel/alarm_console.php?num_alarms_page=50&hmenu=Alarms&smenu=Alarms&hour=00&minutes=00&hide_closed=0&date_from=".gmdate("Y-m-d",$timetz)."&date_to=".gmdate("Y-m-d",$timetz))."'";
$alarm_urls .= ",'../top.php?hmenu=".md5("Incidents")."&smenu=".md5("Tickets")."&url=".urlencode("control_panel/alarm_console.php?num_alarms_page=50&hmenu=Alarms&smenu=Alarms&hour=00&minutes=00&hide_closed=0&date_from=".gmdate("Y-m-d",$timetz-86400)."&date_to=".gmdate("Y-m-d",$timetz-86400))."'";
$alarm_urls .= ",'../top.php?hmenu=".md5("Incidents")."&smenu=".md5("Tickets")."&url=".urlencode("control_panel/alarm_console.php?num_alarms_page=50&hmenu=Alarms&smenu=Alarms&hour=00&minutes=00&hide_closed=0&date_from=".gmdate("Y-m-d",$timetz-172800)."&date_to=".gmdate("Y-m-d",$timetz))."'";
$alarm_urls .= ",'../top.php?hmenu=".md5("Incidents")."&smenu=".md5("Tickets")."&url=".urlencode("control_panel/alarm_console.php?num_alarms_page=50&hmenu=Alarms&smenu=Alarms&hour=00&minutes=00&hide_closed=0&date_from=".gmdate("Y-m-d",$timetz-604800)."&date_to=".gmdate("Y-m-d",$timetz))."'";
$alarm_urls .= ",'../top.php?hmenu=".md5("Incidents")."&smenu=".md5("Tickets")."&url=".urlencode("control_panel/alarm_console.php?num_alarms_page=50&hmenu=Alarms&smenu=Alarms&hour=00&minutes=00&hide_closed=0&date_from=".gmdate("Y-m-d",$timetz-1209600)."&date_to=".gmdate("Y-m-d",$timetz))."'";
?>  
	<script class="code" type="text/javascript">
		...
		function myClickHandler(ev, gridpos, datapos, neighbor, plot) {
            ...
            if (neighbor.seriesIndex==1) url = <?php echo "'../top.php?hmenu=".md5("Incidents")."&smenu=".md5("Tickets")."&url=".urlencode("incidents/index.php?status=&hmenu=Tickets&smenu=Tickets")."';" ?> 

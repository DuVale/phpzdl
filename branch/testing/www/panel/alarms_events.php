...
<head>
	...
	<style type="text/css">
		...
		.nodata { margin: auto; padding: 140px; text-align:center; font-size: 14px; color: #666666; }
	</style>
...
if (GET("type")=="alarms")
	$link = "'../top.php?hmenu=".md5("Incidents")."&smenu=".md5("Alarms")."&url=".urlencode("control_panel/alarm_console.php?num_alarms_page=50&hmenu=Alarms&smenu=Alarms&hide_closed=1&query=QQQ")."',";
else
	$link = "'../top.php?hmenu=".md5("Analysis")."&smenu=".md5("Forensics")."&url=".urlencode("forensics/base_qry_main.php?clear_allcriteria=1&time_range=all&submit=Query+DB&sig_type=1&sig%5B0%5D=%3D&sig%5B1%5D=QQQ&sort_order=time_d&hmenu=Forensics&smenu=Forensics")."',";

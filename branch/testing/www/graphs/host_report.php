...
$query = "select count(*) as howmany,plugin_id from acid_event force index(ip_dst) where $ip_where timestamp>='$time_week'$sensor_where group by plugin_id order by howmany desc limit 10;";

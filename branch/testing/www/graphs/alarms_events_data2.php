...
switch ($counter) {
    ...
    case 2:
        ...
        if ($sensor_where_ac!="")
			...
			$query = "SELECT count(*) as num, plugin_sid.name FROM acid_event LEFT JOIN ossim.plugin_sid ON plugin_sid.plugin_id=acid_event.plugin_id AND plugin_sid.sid=acid_event.plugin_sid GROUP BY name ORDER BY num DESC LIMIT 7";

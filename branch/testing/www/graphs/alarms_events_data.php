...
if ($sensor_where != "")
	...
	$query2 = "SELECT * FROM
	(select count(*) as Today from acid_event where timestamp > CURDATE()) as Today,
	(select count(*) as Yesterd from acid_event where timestamp > DATE_ADD(CURDATE(), INTERVAL -1 DAY) and timestamp <= CURDATE()) as Yesterd,
	(select count(*)".$_2Ago_div." as 2DAgo  from acid_event where timestamp > DATE_ADD(CURDATE(), ".$_2Ago.") and timestamp <= ".$_2Ago_interv.") as 2DAgo,
	(select count(*)".$_Week_div." as Week from acid_event where timestamp > DATE_ADD(CURDATE(), ".$_Week.") and timestamp <= ".$_Week_interv.") as Seamana,
	(select count(*)".$_2Week_div." as 2Weeks from acid_event where timestamp > DATE_ADD(CURDATE(), ".$_2Week.") and timestamp <= ".$_2Week_interv.") as 2Weeks;";
/* Never use accumulates
	$query2 = "SELECT * FROM

...
if (preg_match("/^[a-zA-Z0-9]+[a-zA-Z0-9_\-\.]+\.php$/", $_GET['source_graph'])) 
	echo InsertChart("charts.swf?timeout=120", "charts_library", $_GET['source_graph'] . "?" . $_SERVER['QUERY_STRING']."&bypassexpirationupdate=1&host=$host&rand=".rand(), $width, $height, "#FFF");
else

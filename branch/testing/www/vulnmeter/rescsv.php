...
<tr>
EOT;
echo "<th colspan=\"13\" height=\"46\" style=\"text-align:center;\">$siteBranding: "._("I.T Security Vulnerability Report")."</th>\n";
echo <<<EOT
</tr>
EOT;
...
<tr>
EOT;
   echo "<th colspan=\"13\"> $siteBranding: "._("I.T Security Vulnerability Report")."</th>\n";
echo <<<EOT
</tr>
EOT;
...
echo <<<EOT
   <td colspan="12" style="text-align:left">$scanyear-$scanmonth-$scanday $scanhour:$scanmin:$scansec</td>
</tr>
<tr>
EOT;
   echo "<th>"._("Generated").":</th>";
echo <<<EOT
   <td colspan="12" style="text-align:left">$gendate</td>
</tr>
EOT;
if($ipl=="") {
    echo "<tr>";
    echo "<th>"._("Profile").":</th>";
    echo "<td colspan=\"12\" align=\"left\">$profile_name\n - $profile_desc</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<th>"._("Job Name").":</th>";
    echo "<td colspan=\"12\" align=\"left\">$job_name</td>";  
    echo "</tr>";
}
    ...
    while ( list($hostip) = $result->fields ) {
        ...
        $arrResults="";
          ...
          while ( list($hostname, $service, $risk, $falsepositive, $scriptid, $pname, $msg) = $result1->fields ){
             ...
             echo "    <td style=\"text-align:center\">$cvss</td>";

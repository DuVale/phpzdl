...
$yesterday2_d = gmdate("d", strtotime("-2 day UTC",$timetz));
$yesterday2_m = gmdate("m", strtotime("-2 day UTC",$timetz));
$yesterday2_y = gmdate("Y", strtotime("-2 day UTC",$timetz));
...
$two_week_d = gmdate("d", strtotime("-2 week UTC",$timetz));
$two_week_m = gmdate("m", strtotime("-2 week UTC",$timetz));
$two_week_y = gmdate("Y", strtotime("-2 week UTC",$timetz));
...
$two_month_d = gmdate("d", strtotime("-2 month UTC",$timetz));
$two_month_m = gmdate("m", strtotime("-2 month UTC",$timetz));
$two_month_y = gmdate("Y", strtotime("-2 month UTC",$timetz));
...
$two_year_d = gmdate("d", strtotime("-2 year UTC",$timetz));
$two_year_m = gmdate("m", strtotime("-2 year UTC",$timetz));
$two_year_y = gmdate("Y", strtotime("-2 year UTC",$timetz));
						...
						<tr>
							...
							<td align="right">
								<table width="100%">
									<tr>
										<td nowrap>
										<input type="button" class="button" value="<?php echo ($_SESSION["_idm"]) ? _("IDM") : _("IP") ?>" onclick="$('#ipsearch').toggle()">
										<!-- IDM / IP combo -->
										<div style="position:relative; z-index:2; text-align:left">
											<div id="ipsearch" style="position:absolute;top:0;display:none;margin:1px 0px 0px 2px">
											<?php if ($_SESSION["_idm"]) { ?>
												<input type="submit" class="button" value="<?=_("IDM Username")?>" name="submit" style='width:95px;font-size:11px'>
												<br>
												<input type="submit" class="button" value="<?=_("IDM Hostname")?>" name="submit" style='width:95px;font-size:11px'>							
												<br>
												<input type="submit" class="button" value="<?=_("IDM Domain")?>" name="submit" style='width:95px;font-size:11px'>							
												<br>
											<?php } ?>
												<input type="submit" class="button" value="<?=_("Src or Dst IP")?>" name="submit" style='width:95px;font-size:11px'>
												<br>
												<input type="submit" class="button" value="<?=_("Src IP")?>" name="submit" style='width:95px;font-size:11px'>
												<br>
												<input type="submit" class="button" value="<?=_("Dst IP")?>" name="submit" style='width:95px;font-size:11px'>
											</div>
										</div>	
										</td><td>
			...
			<tr>
				...
				<tr>
					...
					foreach($snortsensors as $plugin_name => $pids) {
						...
						echo "<option value='$pid' $sel>".ucfirst($plugin_name)."</option>\n";
					}
					?>
					</select></td>
						...
						<table cellpadding='0' cellspacing='0' width='100%'>
							<tr>
								<td colspan='2' style="text-align:left;  padding: 5px 5px 10px 0px; width:50%">
											...
											<div id="mfilters" style="position:absolute;left:0;top:0;display:none">
												<table cellpadding='0' cellspacing='0' align="center" style='width: 300px;'>
													...
													<tr class="noborder">
														<td style='padding:5px;'>
															<div style='text-align: left; padding-bottom: 15px; clear: both;'>
																<div style='float: left; width:90px; font-size:11px'><?=_("Host Groups")?>:</div>
																<div style='float: left;'>
																	<select name="addhomeips" class="selectp" style="width:185px" onchange="this.form.bsf.click()"><option value='-1'></option> 
																	<?
																	// 
																	$hg = GetOssimHostGroups();
																	foreach ($hg as $namehg) 
																	{
																		echo "<option value='".$namehg."'".(($_SESSION["_hostgroup"]==$namehg) ? " selected" : "").">$namehg</option>\n";
																	}
                                    ...
                                    $display = ((trim($_SESSION["category"][0])!="") && ($_GET["hidden_menu"] == "0" )) ? "" : "display:none";
                                    
                                    ?>
									
                                    <a style='cursor:pointer; font-weight:bold;' class='ndc' onclick="$('#taxonomy').toggle(); $('#mfilters').hide();"><img src="../pixmaps/arrow_green.gif" align="absmiddle" border="0"/><?php echo _("Taxonomy and Reputation Filters")?></a>
									   <div style="position:relative; z-index:2; text-align:left;">
											<div id="taxonomy" style="position:absolute;left:-60;top:0;<?=$display?>">
												<table cellpadding='0' cellspacing='0' align="center" style='width: 270px;'>
													...
													<tr class="noborder">
														<td style='padding:5px;'>										    											
															...
															<div style='text-align: left; padding-bottom: 15px; clear: both;'>
																...
																<div style='float: left;'>
																	<select name="category[0]" id="category" class="selectp" style="width:155px" onchange="$('input[name=plugin]').val('');$('input[name=hidden_menu]').val('0');this.form.bsf.click()"><option value=''></option> 
																	<?
													...
													<tr>
														<th style="padding-right:3px">
															<div style='float:left; width:100%; text-align:center;'><?php echo _("IP Reputation")?></div>
														</th>
													</tr>				
													<?
														$rep_activities = array("ANY", "C&C", "Malicious Host", "Malware", "Malware distribution", "Malware Domain", "Malware IP", "Phishing", "RBN", "RBN Malvertisers", "scanning-host", "Spamming", "Tor exit node");
														$rep_severities = array("ANY", "High", "Medium", "Low");														
													?>
													<tr class="noborder">
														<td style='padding:5px;'>
															<div style='text-align: left; padding-bottom: 15px; clear: both;'>
																<div style='float: left; width:90px;'><?=_("Activity")?>:</div>
																<div style='float: left;'>
																	<select name="rep[0]" id="activity" class="selectp" style="width:155px" onchange="this.form.bsf.click()"><option value=''></option> 
																	<?
																	foreach ($rep_activities as $act) echo "<option value=\"$act\"".(($_SESSION["rep"][0]!="" && $_SESSION["rep"][0]==$act) ? " selected" : "").">$act</option>\n";
																	?>
																	</select>
																</div>
															</div>
															...
															<div style='text-align: left; padding-bottom: 15px; clear: both;'>
																<div style='float: left; width:90px;'><?=_("Severity")?>:</div>
																<div style='float: left;'>
																	<select name="rep[1]" id="severity" class="selectp" style="width:155px" onchange="this.form.bsf.click()"><option value=''></option> 
																	<?
																	foreach ($rep_severities as $sev) echo "<option value=\"$sev\"".(($_SESSION["rep"][1]!="" && $_SESSION["rep"][1]==$sev) ? " selected" : "").">$sev</option>\n";
																	?>
																	</select>
																</div>
															</div>															
								...
								<? }else{ ?>
									...
									<a style='cursor:pointer; font-weight:bold;' class='ndc' onclick="$('#taxonomy').toggle(); $('#mfilters').hide();"><img src="../pixmaps/arrow_green.gif" align="absmiddle" border="0"/><?php echo _("Reputation Filters")?></a>
									   <div style="position:relative; z-index:2; text-align:left;">
											<div id="taxonomy" style="position:absolute;left:-60;top:0;<?=$display?>">
												<table cellpadding='0' cellspacing='0' align="center" style='width: 270px;'>
													<tr>
														<th style="padding-right:3px">
															<div style='float:left; width:60%; text-align: right;'><?php echo _("IP Reputation")?></div>
															<div style='float:right; width:18%; padding-top: 2px; text-align: right;'><a style="cursor:pointer; text-align: right;" onclick="$('#taxonomy').toggle(); $('#mfilters').hide();"><img src="../pixmaps/cross-circle-frame.png" alt="<?php echo _("Close"); ?>" title="<?php echo _("Close"); ?>" border="0" align='absmiddle'/></a></div>
														</th>
													</tr>
													<?
...
<script>
	...
	function postload() {
		...
		if ($_SESSION["time_cnt"]==2) {
			$y1 = ($_SESSION["time"][0][4]!="") ? $_SESSION["time"][0][4] : gmdate("Y",$timetz);
			$m1 = ($_SESSION["time"][0][2]!="") ? $_SESSION["time"][0][2]-1 : gmdate("m",$timetz);
			$m11 = ($_SESSION["time"][0][2]!="") ? $_SESSION["time"][0][2] : gmdate("m",$timetz);
			$d1 = ($_SESSION["time"][0][3]!="") ? $_SESSION["time"][0][3] : gmdate("d",$timetz);
			$y2 = ($_SESSION["time"][1][4]!="") ? $_SESSION["time"][1][4] : gmdate("Y",$timetz);
			$m2 = ($_SESSION["time"][1][2]!="") ? $_SESSION["time"][1][2]-1 : gmdate("m",$timetz);
			$m21 = ($_SESSION["time"][1][2]!="") ? $_SESSION["time"][1][2] : gmdate("m",$timetz);
			$d2 = ($_SESSION["time"][1][3]!="") ? $_SESSION["time"][1][3] : gmdate("d",$timetz);
		?>
    ...
    function dsgroup_for_selected() {
    	...
    	if (idlist != "" && sidlist != "") {
    		GB_show("Insert to DS Group","../policy/insertsid.php?plugin_id="+idlist+"&plugin_sid="+sidlist,'650','65%');
    	}
    }

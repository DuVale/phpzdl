...
CREATE TABLE IF NOT EXISTS `acid_event` (
  ...
  `src_username` varchar(64) NULL,
  `dst_username` varchar(64) NULL,
  `src_domain` varchar(64) NULL,
  `dst_domain` varchar(64) NULL,
  `src_hostname` varchar(64) NULL,
  `dst_hostname` varchar(64) NULL,
  `src_mac` varchar(17) NULL,
  `dst_mac` varchar(17) NULL,  
...
REPLACE INTO `base_roles` (`role_id`, `role_name`, `role_desc`) VALUES (1, 'Admin', 'Administrator'),
...
REPLACE INTO detail (detail_type, detail_text) VALUES (0, 'fast');
REPLACE INTO detail (detail_type, detail_text) VALUES (1, 'full');
...
REPLACE INTO encoding (encoding_type, encoding_text) VALUES (0, 'hex');
REPLACE INTO encoding (encoding_type, encoding_text) VALUES (1, 'base64');
REPLACE INTO encoding (encoding_type, encoding_text) VALUES (2, 'ascii');
-- --------------------------------------------------------
...
REPLACE INTO last_update VALUES ('1970-01-01 00:00:00');
-- --------------------------------------------------------
...
REPLACE INTO `reference_system` (`ref_system_id`, `ref_system_name`, `icon`, `url`) VALUES
...
REPLACE INTO `schema`  (vseq, ctime) VALUES ('200', now());

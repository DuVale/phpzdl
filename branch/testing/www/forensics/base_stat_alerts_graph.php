...
while (($myrow = $result->baseFetchRow()) && ($i < $qs->GetDisplayRowCnt())) {
    ...
    qroPrintEntry('<A HREF="base_stat_sensor.php?sig%5B0%5D=%3D&amp;sig%5B1%5D=' . urlencode($sig_id) . '&amp;sig_type=1">' . $num_sensors . '</A>', 'center', 'middle');
    ...
    $sqlgr = str_replace("PLUGINID", $myrow["plugin_id"], $sqlgraph);
    $sqlgr = str_replace("PLUGINSID", $myrow["plugin_sid"] , $sqlgr);
    //echo $sqlgr."<br>";

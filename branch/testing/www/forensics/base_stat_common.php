...
function PrintGeneralStats($db, $compact, $show_stats, $join = "", $where = "", $show_total_events = false) {
    ...
    $unique_ptypes_info[1] = " <a style='color:black;font-weight:bold' href=\"base_stat_ptypes.php?sort_order=occur_d\">";
    $unique_ptypes_info[2] = "</a>";
    $unique_categories_info[0] = gettext("Categories");;
    $unique_categories_info[1] = " <a style='color:black;font-weight:bold' href=\"base_stat_categories.php?sort_order=occur_d\">";
...
?>
	  ...
	  <?php
        ...
        $color = (preg_match("/base_stat_uaddr|base_stat_uidm/", $_SERVER['SCRIPT_NAME'])) ? "#28BC04" : "#FFFFFF";
        ...
        // IDM
        if ($_SESSION["_idm"]) {
        	$uat = "<a style='color:".(($color == "#28BC04") ? "white" : "black").";font-weight:bold' href='javascript:;' onclick=\"$('#uniqueaddrsrc').hide();$('#uniqueaddrdst').hide();$('#uniqueaddr').toggle()\">".gettext("Unique")."</a>
        	<div style='position:relative; z-index:2; text-align:left'><div id='uniqueaddr' style='position:absolute;top:0;display:none;padding:2px 5px;margin:-21px 0px 0px 115px;background-color:#fefefe;border:1px solid #CACACA;white-space:nowrap;'>
        	<a style='color:black;font-weight:bold' href='base_stat_uaddress.php?sort_order=occur_d'>IP Addresses</a><br>
        	<a style='color:black;font-weight:bold' href='base_stat_uidm.php?addr_type=username&sort_order=occur_d'>Usernames</a><br>
        	<a style='color:black;font-weight:bold' href='base_stat_uidm.php?addr_type=hostname&sort_order=occur_d'>Hostnames</a><br>
        	<a style='color:black;font-weight:bold' href='base_stat_uidm.php?addr_type=domain&sort_order=occur_d'>Domains</a>
        	</div></div>";
        	$uatsrc = "<a style='color:".(($color == "#28BC04") ? "white" : "black").";font-weight:bold' href='javascript:;' onclick=\"$('#uniqueaddr').hide();$('#uniqueaddrdst').hide();$('#uniqueaddrsrc').toggle()\"><font style='text-decoration:$addrtype1'>".gettext("Source")."</font></a>".(($_GET['addr_type'] == '1' && preg_match("/base_stat_uaddr/", $_SERVER['SCRIPT_NAME'])) ? $pdf . $csv : "" )."
        	<div style='display:inline;position:relative; z-index:2; text-align:left'><div id='uniqueaddrsrc' style='position:absolute;top:0;display:none;padding:2px 5px;margin:-7px 0px 0px 1px;background-color:#fefefe;border:1px solid #CACACA;white-space:nowrap;'>
        	<a style='color:black;font-weight:bold' href='base_stat_uaddr.php?sort_order=occur_d&addr_type=1'>IP Addresses</a><br>
        	<a style='color:black;font-weight:bold' href='base_stat_uidmsel.php?addr_type=src_username&sort_order=occur_d'>Usernames</a><br>
        	<a style='color:black;font-weight:bold' href='base_stat_uidmsel.php?addr_type=src_hostname&sort_order=occur_d'>Hostnames</a><br>
        	<a style='color:black;font-weight:bold' href='base_stat_uidmsel.php?addr_type=src_domain&sort_order=occur_d'>Domains</a>
        	</div></div>";
        	$uatdst = "<a style='color:".(($color == "#28BC04") ? "white" : "black").";font-weight:bold' href='javascript:;' onclick=\"$('#uniqueaddr').hide();$('#uniqueaddrsrc').hide();$('#uniqueaddrdst').toggle()\"><font style='text-decoration:$addrtype2'>".gettext("Destination")."</font></a>".(($_GET['addr_type'] == '2' && preg_match("/base_stat_uaddr/", $_SERVER['SCRIPT_NAME'])) ? $pdf . $csv : "" )."
        	<div style='position:relative; z-index:2; text-align:left'><div id='uniqueaddrdst' style='position:absolute;top:0;display:none;padding:2px 5px;margin:-21px 0px 0px 150px;background-color:#fefefe;border:1px solid #CACACA;white-space:nowrap;'>
        	<a style='color:black;font-weight:bold' href='base_stat_uaddr.php?sort_order=occur_d&addr_type=2'>IP Addresses</a><br>
        	<a style='color:black;font-weight:bold' href='base_stat_uidmsel.php?addr_type=dst_username&sort_order=occur_d'>Usernames</a><br>
        	<a style='color:black;font-weight:bold' href='base_stat_uidmsel.php?addr_type=dst_hostname&sort_order=occur_d'>Hostnames</a><br>
        	<a style='color:black;font-weight:bold' href='base_stat_uidmsel.php?addr_type=dst_domain&sort_order=occur_d'>Domains</a>
        	</div></div>";
        } else {
...
?>"><?php echo $uat . $uatsrc . " | " . $uatdst ?></td>
	  ...
	  <?php
	    # SRC/DST PORTS
        $color = (preg_match("/base_stat_ports\.php/", $_SERVER['SCRIPT_NAME'])) ? "#28BC04" : "#FFFFFF";
        if ($color == "#28BC04" && $_GET['port_type'] == 1) {
                                    ...
                                    if (!$cloud_instance) {
                                    	...
                                    	$csvs = "<a href=\"javascript:;\" onclick=\"javascript:report_launcher('SourcePort_Report$report_type','$src_port_report_type');return false\"><img src=\"images/csv-icon.png\" border=\"0\" align=\"absmiddle\" title=\""._("Download data in csv format")."\"></a> &nbsp;";
                                    } else  { $pdfs = ""; $csvs=" ";} 
       } elseif ($color == "#28BC04" && $_GET['port_type'] == 2) {
                                    ...
                                    if (!$cloud_instance) {
                                    	...
                                    	$csvd = "<a href=\"javascript:;\" onclick=\"javascript:report_launcher('DestinationPort_Report$report_type','$dst_port_report_type');return false\"><img src=\"images/csv-icon.png\" border=\"0\" align=\"absmiddle\" title=\""._("Download data in csv format")."\"></a> &nbsp;";
                                    } else  { $pdfd = ""; $csvd=" ";} 
...
<?php
	    # TAXONOMY
        $color = (preg_match("/base_stat_ptypes\.php|base_stat_categories\.php/", $_SERVER['SCRIPT_NAME'])) ? "#28BC04" : "#FFFFFF";
        if ($color == "#28BC04") {

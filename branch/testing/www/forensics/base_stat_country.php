...
?>
	<tr bgcolor="<?=$cc?>">
		...
		<td align="center"><a href="base_stat_country_alerts.php?cc=unknown&location=alerts"><?=Util::number_format_locale($country_uhn['Unknown'],0)?></a></td>
		<td align="center">
			<? if ($country_uhn['srcnum']>0) { ?><a href="base_stat_country_alerts.php?cc=unknown&location=srcaddress"><?=Util::number_format_locale($country_uhn['srcnum'],0)?></a></td>
			<? } else echo "0" ?>
		<td align="center">
			<? if ($country_uhn['dstnum']>0) { ?><a href="base_stat_country_alerts.php?cc=unknown&location=dstaddress"><?=Util::number_format_locale($country_uhn['dstnum'],0)?></a>
			<? } else echo "0" ?>
			</td>
		  </TR>
		 </TABLE>

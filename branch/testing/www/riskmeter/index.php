...
<table align="center">
    <!-- configure refresh -->
    <tr>
        <td colspan="2" nowrap><?php echo gettext("Page Refresh"); ?>: 
            <!-- decrease refresh -->
    ...
    <tr>
        <td><a href="<?php echo $_SERVER["SCRIPT_NAME"] ?>"><?php echo gettext("Global"); ?> </a></td>
        <td align="center">
            <a href="<?php echo "../control_panel/show_image.php?range=day" . "&ip=global_" . $_SESSION["_user"] . "&what=compromise&start=N-1D&type=global&zoom=1" ?>" target="main">&nbsp;<img src="../pixmaps/graph.gif" border="0"/>&nbsp;</a>
        </td>
        ...
        while ($temporary) 
        {
            ...
            <tr>
                <td align="center">
                    ...
                    { 
                        ?>
                        <a href="<?php echo $_SERVER["SCRIPT_NAME"] ?>?expand=<?php echo $group_name; ?>"><?php echo Util::beautify($group_name); ?></a>
                        <?php
                    } 
                    ?>
                </td>
                ...
                <td align="center">
                    <a href="<?php echo "../control_panel/show_image.php?range=day&ip=" . $group_name . "&what=compromise&start=N-1D&type=net&zoom=1"?>" target="main">&nbsp;<img src="../pixmaps/graph.gif" border="0"/>&nbsp;</a>
                </td>
    ...
    if ($net_stats) foreach($net_stats as $stat) 
    {
        ...
        <tr>
            ...
            { 
                ?>
                <a href="<?php echo $_SERVER["SCRIPT_NAME"] . "?expand=" . $expand . "&net=$net" ?>"><?php echo Util::beautify($net) ?></a>
                <?php
            } 
            else 
            { 
                ?>
                <a href="<?php echo $_SERVER["SCRIPT_NAME"] . "?net=$net" ?>"><?php echo Util::beautify($net) ?></a>
                <?php
            } 
            ?>
            </td>
            ...
            <td align="center">
                <a href="<?php echo "../control_panel/show_image.php?range=day&ip=" . $net . "&what=compromise&start=N-1D&type=net&zoom=1"?>" target="main">&nbsp;<img src="../pixmaps/graph.gif" border="0"/>&nbsp;</a>
            </td>
...
?>
    ...
    <tr>
        <th align="center" colspan="3">
            <a name="Hosts" href="<?php echo $_SERVER["SCRIPT_NAME"] ?>?#Hosts" title="Fix"><?php echo gettext("Hosts") ?></a>
        </th>
    </tr>
    <tr><td colspan="3"></td></tr>
    ...
    if (isset($ip_stats)) 
    {
        foreach($ip_stats as $stat) 
        {
            ...
            <tr>
                <td align="center">
                    <a href="../report/metrics.php?host=<?php echo $ip ?>&hmenu=Risk&smenu=Metrics" title="<?php echo $ip ?>"><?php echo $hostname ?></a>
                    <?php echo Host_os::get_os_pixmap($conn, $ip); ?>
                </td>
                
                <td align="center">
                    <a href="<?php echo "../control_panel/show_image.php?range=day&ip=$ip&what=compromise&start=N-1D&type=host&zoom=1"?>" target="main">&nbsp;<img src="../pixmaps/graph.gif" border="0"/>&nbsp;</a>
                </td>

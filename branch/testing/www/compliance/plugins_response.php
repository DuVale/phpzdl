...
switch($compliance){
	...
	case "ISO27001":
		...
		break;
	case "N052":
		$groups = N052::get_groups($conn);
		break;
	case "ModeloATH":
		$groups = ModeloATH::get_groups($conn);
		break;
}
...
if (count($plugin_list) > 0) 
{
    ...
    <table width="100%" align="center">
        ...
        { 
            ...
            $noborder = ( $i == $size -1 ) ? " class='noborder'" : "";
            ?>
            <tr><td style='background:<?php echo $bg_color?>'<?php echo $noborder?>><?=$p->get_name()?></td></tr>
            <?php
            $i++;
        } 
        ?>
...
{ 
    ?>
    <table width="100%">
        <tr><td class="nobborder" style="padding:10px;text-align:center"><b><?php echo _("No directives found")?></b></td></tr>
    </table>
    <?php 
} 
?>
...
<link type="text/css" rel="stylesheet" href="../style/zoomy1.2.css" />
...
<?php include ("../hmenu.php"); ?>
	...
	<table cellpadding=0 cellspacing=0 class="noborder" style="width: 90%; background: transparent;"">
		<tr>
			<td class="noborder" width="100%" >
				<table cellpadding=0 cellspacing=0 class="noborder" style="width: 100%; background: transparent;">
					<tr><td class="headerpr">AlienVault Logger: Secure Reliable Storage</td></tr>
					<tr><td class="noborder" ><table width="100%" height="230" cellspacing="0" cellpadding="0" ><tr><td class="noborder" style="vertical-align: top; padding-top:5px; text-align:left; max-width:500px;">
						...
						<p>
							<a href='http://alienvault.com/about/contact' target='_blank' title='Profesional SIEM'>
								This feature is only available in Alienvault Prefessional SIEM. If you want to try it, please click here
							</a>
						</p>
						
					</td><td class="noborder" style="padding:10px;">
					...
					<tr><td class="headerpr">AlienVault Logger Features</td></tr>
					<tr><td class="noborder" ><table width="100%" height="230" cellspacing="0" cellpadding="0" ><tr><td class="noborder" style="vertical-align: top; padding-top:5px; text-align:left; max-width:500px;">
						
						<p>The AlienVault Logger is a forensically-secure solution to long term storage of raw log data. Logger addresses security, legal and compliances needs through:</p>
						<ul>
					...
					<tr><td class="noborder" style="background: transparent;">&nbsp;</td></tr>
					<tr><td class="headerpr">Highlights</td></tr>
					<tr><td class="noborder" ><table width="100%" height="230" cellspacing="0" cellpadding="0" ><tr><td class="noborder" style="vertical-align: top; padding-top:5px; text-align:left; max-width:500px;">
						<ul>
						
							<li>Full Forensic Lifecycle Management:<br />
								from Collection to Storage to Destruction</li>
					...
					<tr><td class="noborder" style="background: transparent;">&nbsp;</td></tr>
					<tr><td class="headerpr">Forensic Lifecycle Management</td></tr>
					<tr><td class="noborder" ><table width="100%" height="230" cellspacing="0" cellpadding="0" ><tr><td class="noborder" style="vertical-align: top; padding-top:5px; text-align:left; max-width:500px;">

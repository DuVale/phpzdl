...
switch ($target_url) {
    ...
    case "top_hosts":
        $url = "/ossim/report/host_report.php?asset_type=host&asset_key=" . GET('category');
        break;
    ...
    case "events_sensor":
        ...
        if (strlen($plugin) < 2) {
            ...
            // Assume Plugin
            $url = "/ossim/index.php?hmenu=".md5("Analysis")."&smenu=".md5("Forensics")."&url=%2Facidbase%2F%2Fbase_qry_main.php%3F%26num_result_rows%3D-1%26submit%3DQuery%2BDB%26current_view%3D-1%26sort_order%3Dtime_d";
        } else {
            // Asume both
    ...
    case "inventory":
        $url = "/ossim/index.php?hmenu=".md5("Assets")."&smenu=".md5("Assets")."&url=ocsreports%2Findex.php";
        break;

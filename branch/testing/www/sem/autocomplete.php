...
if (trim($str) != "") 
{
	...
	// Typing a tag
	if (preg_match("/^(sensor|src|dst|ip|plugin|datasource|plugingroup|dsgroup|src_port|dst_port|product_type|event_category|category|data)(\!?\=)(.*)/i",$str,$found)) 
    {
		$tag_typing = 1;
		$str        = $found[3];
		$op         = $found[2];
        ...
        elseif ($found[1] == "src" || $found[1] == "dst" || $found[1] == "ip") 
        {

			...
			<td class="canvas" width="722">
				<table cellpadding='0' cellspacing='0' border='0' height="62" width='100%'>
					...
					<tr>
                        ...
                        <?php
                        if (Session::menu_perms("MenuIncidents", "IncidentsIncidents") || Session::menu_perms("MenuIncidents", "ControlPanelAlarms")) {
                        ?>
						<td>
                       ...
                       <?php
						...
						<td width="20" align="center"><img src="pixmaps/statusbar/bg_sep.gif" border='0'/></td>
                        <?php if (Session::menu_perms("MenuIncidents", "IncidentsIncidents") || Session::menu_perms("MenuIncidents", "ControlPanelAlarms")) { ?>
						<td>
							<table cellpadding='0' cellspacing='0' border='0'>
                            <?php 
                            if (Session::menu_perms("MenuIncidents", "IncidentsIncidents") {
									...
									<table cellpadding='0' cellspacing='0' border='0'>
										...
										<tr>
											<td width='86px' height='30px' class="level11" nowrap='nowrap' align="center" id="service_level_gr">
												<a href="top.php?option=0&soption=1&url=<?=urlencode("control_panel/show_image.php?range=day&ip=level_admin&what=attack&start=N-1D&end=N&type=level&zoom=1&hmenu=Risk&smenu=Metrics")?>" target="topmenu" id="service_level" class="black" style="text-decoration:none">-</a>
											</td>
										</tr>
									</table>
								</td>

 ...
 * @version   SVN: $Id: class.Webpage.inc.php 317 2009-09-03 08:10:31Z bigmichi1 $
...
class Webpage extends Output implements PSI_Interface_Output
{
    ...
    public function run()
    {
        ...
        echo "          <span id=\"s_ip_title\"></span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a target='main' href='/ossim/report/host_report.php?hmenu=Sysinfo&smenu=Sysinfo&asset_type=any&asset_key=&star_date=".gmdate("Y-m-d",$timetz-604800)."&end_date=".gmdate("Y-m-d",$timetz)."' style='text-decoration:none;text-transform:none;color:black'><img src='../pixmaps/chart_bar.png' border='0' align='absmiddle'> Resources</a> \n";*/
        echo "        </span>\n";
        echo "      </h1>\n";
        /*echo "      <div id=\"select\">\n"; 

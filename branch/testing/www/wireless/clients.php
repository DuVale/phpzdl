...
foreach ($clients as $data) {
	...
	<td><a target='main' class='HostReportMenu' id='".$data['ip'].";".$data['ip']."' href='../report/host_report.php?asset_type=host&asset_key=".$data['ip']."&hmenu=Host+Report&smenu=Host+Report'>".$data['ip']."</a></td>
	<td>".$data['type']."</td>

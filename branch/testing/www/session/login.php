...
$customize_wizard = ( $conf->get_conf("customize_wizard", FALSE) == 1 ) ? true : false;

if( $cloud_instance && $customize_wizard ) {  // redirect to the wizard cloud
...
?>
	...
	<form method="POST" action="login.php" onsubmit="$('#pass').val($.base64.encode($('#passu').val()));$('#submit_button').attr('disabled','disabled')" style="margin:0px">
		...
		<tr>
			<td class="nobborder">
				<table align="center" class="noborder" style="background-color:white">
					...
					<tr>
						<td class="nobborder center" style="padding:10px">
							<table align="center" cellspacing='2' cellpadding='6' style="background-color:#eeeeee;border-color:#dedede;opacity:0.5">
								<tr>
									<td style="text-align:right;font-size:14px" class="nobborder"> <?php echo gettext("User").":"; ?> </td>
									<td style="text-align:left" class="nobborder">
										<input type="text" size="18" autocapitalize="off" style="border:none;background-color:#fefefe" name="user" />
									</td>
								</tr>
								<tr>
									<td style="text-align:right;font-size:14px" class="nobborder"> <?php echo gettext("Password").":"; ?> </td>
									<td style="text-align:left" class="nobborder">
										<input type="password" id="passu" size="18" style="border:none;background-color:#fefefe" name="passu"/>
					...
					<tr>
						<td class="nobborder" style="text-align:center;height:24px;font-size:12px">
							<input type="checkbox" value="status" name="mobile" checked/> <?php echo _("Mobile Console") ?>
						</td>
					</tr>
					<tr>
						<td class="nobborder" style="text-align:center;padding:10px;">
							<input type="submit" id="submit_button" value="<?php echo gettext("Login"); ?>" class="button"/>
						</td>
					</tr>

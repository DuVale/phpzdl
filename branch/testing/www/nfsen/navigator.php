...
?>
    <div style="position:absolute;right:95px;top:0px;vertical-align:bottom;width:450px;">
        <table border=0 align="right" style="margin:0px;padding:0px;background-color:transparent;border:0px none">
        <tr><td align="right" class="black" nowrap style="background-color:transparent;border:0px none">
            <a class="black<?=($_SESSION['tab']==2) ? "n" : ""?>" href="main.php?tab=2&hmenu=Network&smenu=Network"><?=_("Details")?></a> |
			<a class="black<?=($_SESSION['tab']==0) ? "n" : ""?>" href="main.php?tab=0&hmenu=Network&smenu=Network"><?=_("Overview")?></a> |
            <a class="black<?=($_SESSION['tab']==1) ? "n" : ""?>" href="main.php?tab=1&hmenu=Network&smenu=Network"><?=_("Graphs")?></a>
            
        </td>
        <td align="right" class="black" nowrap style="padding-left:40px;padding-right:20px;background-color:transparent;border:0px none">
            ...
            <a class="black<?=($_SESSION['tab']==3) ? "n" : ""?>" href="main.php?tab=3&hmenu=Network&smenu=Network"><?=_("Alerts")?></a> |
            <a class="black<?=($_SESSION['tab']==4) ? "n" : ""?>" href="main.php?tab=4&hmenu=Network&smenu=Network"><?=_("Stats")?></a> |
            <a class="black<?=($_SESSION['tab']==5) ? "n" : ""?>" href="main.php?tab=5&hmenu=Network&smenu=Network"><?=_("Plugins")?></a> |
            <a class="black" href="<?php echo "../top.php?hmenu=".md5("Configuration")."&smenu=".md5("SIEM Components")."&url=".urlencode("sensor/sensor.php?hmenu=SIEM+Components&smenu=SIEM+Components") ?>" target="topmenu"><?=_("Sensors")?></a>
        </td></tr>
        </table>
    </div>

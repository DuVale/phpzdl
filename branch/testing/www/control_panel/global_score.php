				...
				{ 
					...
					foreach($networks as $net_name => $net_data) 
					{
						...
						<tr>
							...
							<a href="../report/host_report.php?asset_type=net&asset_key=<?=$net_name?>" id="<?=$net_data['address']?>;<?=$net_name?>" class="NetReportMenu"><b><?php echo $net_name?></b></a>
						</td>

...
<form name="fgroup" action="alarm_group_console.php" method="get" target="_parent">
	...
	<table cellpadding='0' cellspacing='0' border='0' class="noborder" width="100%">
		...
		<tr><td class="nobborder" style="text-align:center"><?php echo _("Group alarms into an <strong>existing group</strong>")?>:</td></tr>
		<tr>
			<td class="nobborder" style="padding-top:15px;text-align:center">
				<select name="group">
				<?php
				foreach($alarm_group as $group) 
				{ 
					?>
					<option value="<?php echo $group->get_group_id() ?>">G<?php echo $group->get_group_id() ?></option>
					<?php
				} 
				?>
				</select>
		...
		<tr><td class="nobborder" style="padding-top:5px;text-align:center"><input type="submit" value="OK" class="button"/></td></tr>
	</table>
</form>
</body>

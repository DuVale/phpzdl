...
?>
    <table width="100%">
       ...
       <tr>
         <td colspan="9"><a href="alarm_console.php?hide_closed=1"> <?php echo gettext("Back to main"); ?> </a></td>
       </tr>
...
list($alarm_list, $total_events) = Alarm::get_events($conn, $backlog_id, $show_all, $event_id, 0, 9999999, $alarms_numbering);
if ($total_events>0 && $alarm_list) {
    $count_events = 0;
    $count_alarms = 0;

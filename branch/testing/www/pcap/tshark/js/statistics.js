statistics1 = function (div) {
    ...
    parent.GB_changetitle("Graphs: All Trafic");
...
statistics1f = function (div) {
    $("buttomlink").context.activeElement.childNodes[0].children[2].className = 'buttonlinksel';
    parent.GB_changetitle("Graphs: All Trafic Vs Filter Trafic");
    document.getElementById(div).innerHTML="";
...
statisticsproto = function (div) {
    ...
    document.getElementById(div).innerHTML="";
    parent.GB_changetitle("Graphs: Protocol Trafic");
    var r = Raphael(div, 790, 300),
        e = [],
        clr = [],
...
statisticsprotofilter = function (div) {
    ...
    parent.GB_changetitle("Graphs: Protocol Filter Trafic");
    document.getElementById(div).innerHTML="";
    var r = Raphael(div, 790, 300),
        e = [],
        clr = [],

...
<table align="center" style='<?php echo $table_style?>'>
	<tr>
		<td class="headerpr" height="20">
            <?php $latest_vuln = (  count($param['assets']['data']['ip_cidr']) > 1 ) ? _("Latest Vulnerabilities"). " <i>($host)</i>" : _("Latest Vulnerabilities");?>
            <a style="color:black" href="<?php echo $temp_url?>"><?php echo $latest_vuln; ?></a>
        </td>
	</tr>
            ...
            <td valign="top">
                <table>
                    <tr>
                        ...
                        <?php if ( $param['assets']['type'] == 'net' || $param['assets']['type'] == 'net_group' || $param['assets']['type'] == 'any' ) { ?><th>IP</th><? } ?>
                    </tr>
                    <?php 
                    ...
                    { 
                        ...
                        ?>
                        <tr>
                            <td bgcolor="<?php echo $color?>" style="text-align:left;color: #17457c;font-size:10px"><b><?php echo $vul_event['name']?></b></td>
                        ...
                        <?php 
                        if ( $param['assets']['type'] == 'net' || $param['assets']['type'] == 'net_group' || $param['assets']['type'] == 'any' ) 
                        { 
                            ?>
                            <td bgcolor="<?=$color?>">
                                <a href="host_report.php?asset_type=host&asset_key=<?=$vul_event['ip']?>" class="HostReportMenu" id="<?=$vul_event['ip']?>;<?=$vul_event['ip']?>"><?=$vul_event['ip']?></a>
                            </td>
                            <?php 
                        } 
                        ?>

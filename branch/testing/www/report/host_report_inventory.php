	...
	<tr>
                    ...
                    <tr>
                        <td colspan="2" class="nobborder">
                            ...
                            <script type='text/javascript'>
                                ...
                                {
                                    if ( $('#scrolltable').hasClass('normal') )
                                    {
                                        $('#scrolltable').removeClass();
                                        $('#scrolltable').addClass('maximize');
                                        $('#scrolltable').css({'overflow':'auto','height': '250px'});
                                        $('#txt_p').html('<< <?php echo _("Minimize Properties")?>');
                                    }
                                    else
                                    {
                                        $('#scrolltable').removeClass();
                                        $('#scrolltable').addClass('normal');
                                        $('#scrolltable').css({'overflow':'hidden','height': '100px'});
                                        $('#txt_p').html('<?php echo _("Maximize Properties")?> >>');
                                    }
                                }
                                ...
                                $(document).ready(function(){ 
                                    ...
                                    $('#show_services').bind('click', function()  { show_services(); });	
                                });
                            </script>
                        </td>
                    </tr>
					...
					<td colspan="2" class="nobborder">
						<form method="GET" action="<?php echo $_SERVER['SCRIPT_NAME'] ?>">
							<style type="text/css">
								...
								#tableServices .tableServices_t1, #tableServices .tableServices_t2 { width: 40%; }
								#tableServices .tableServices_t3{ width: 20%; }
								
								
								#tableServices .tableServices_th1, tableServices .tableServices_th2{	
									width: 40%; 
									font-size:11px;
								...
								#tableServices .tableServices_th3{
									width: 20%; 
									font-size:11px;
								}
                            ...
                            <div id='cont_services'><a id='show_services'><span id='txt_p'><?php echo _("Maximize Properties")?> >></span></a></div>
                            
                            <div id='scrolltable' class='normal'>
                            	<table id="tableServices" class="noborder">
									<tr>
										<th class="tableServices_th1"> <?php echo _("Property"); ?> </th>
										<th class="tableServices_th2"> <?php echo _("Version"); ?> </th>
										<th class="tableServices_th3"> <?php echo _("Date"); ?> </th>
									</tr>
									...
									{
										?>
										<td colspan='3'><?php echo _("No data available")?></td>
										<?php
									}
		...
		<td valign="top">
			<table style='width: 100%; height: 100%;'>
				<tr>
					<td class="headerpr" height="20"><?php echo _("Network Usage"); ?></td>
				</tr>
								
				<tr>
					<td id='<?php echo "graph_".generate_id($host)."_1"?>'><img src="../pixmaps/ntop_graph_thumb_gray.gif"/></td>
				</tr>
				
                <tr>
					<td id='<?php echo "graph_".generate_id($host)."_2"?>'><img src="../pixmaps/ntop_graph_thumb_gray.gif"/></td>
				</tr>
			</table>
		</td>
	</tr>

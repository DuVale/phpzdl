...
foreach($host_list as $host) 
{
    ...
    if ($linkedocs = Repository::have_linked_documents($conn, $ip, 'host'))
    	$rep.= "<a href=\"javascript:;\" onclick=\"GB_edit('../repository/repository_list.php?keyname=" . urlencode($ip) . "&type=host&nosize=1')\" class=\"blue\" target=\"main\">[" . $linkedocs . "]</a>&nbsp;";
    ...
    $rep.= "&nbsp;<a href='../top.php?hmenu=".md5("Incidents")."&smenu=".md5("Repository")."&url=".urlencode("repository/index.php?hmenu=Repository&smenu=Repository")."' target='topmenu'><img src=\"../pixmaps/tables/table_edit.png\" title=\"Edit KDB\" alt=\"Edit KDB\" border=0 align=\"absmiddle\"></a>";

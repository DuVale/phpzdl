...
from DoNfsen import NfsenManager
            ...
            try:
                ...
                if len(line) > 0:
                    ...
                    # otherwise we are some form of standard control message
                        ...
                        if self.__nfsenmanager == None:
                            self.__nfsenmanager = NfsenManager(OssimConf(Const.CONFIG_FILE))

                        response = self.__nfsenmanager.process(line)

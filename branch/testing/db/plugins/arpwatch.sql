...
INSERT IGNORE INTO plugin (id, type, name, description) VALUES (1512, 1, 'arpwatch', 'Ethernet/FDDI station monitor daemon');

-- INSERT IGNORE INTO plugin (id, type, name, description) VALUES (2002, 2, 'arp_watch', 'Arpwatch'); -- FIXME: still in use?

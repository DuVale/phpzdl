...
INSERT INTO plugin (id, type, name, source_type, vendor, description) VALUES (1504, 1, 'fw1ngr60', 'Firewall' , 'CheckPoint' , 'Firewall-1 NG R60 Checkpoint');

INSERT INTO plugin_sid (plugin_id, sid, category_id, class_id, priority, reliability, subcategory_id, name) VALUES (1504, 1, 3, 0, 2, 0, 75, 'fw1ngr60: Accept');
INSERT INTO plugin_sid (plugin_id, sid, category_id, class_id, priority, reliability, subcategory_id, name) VALUES (1504, 2, 3, 0, 2, 3, 76, 'fw1ngr60: Reject');
INSERT INTO plugin_sid (plugin_id, sid, category_id, class_id, priority, reliability, subcategory_id, name) VALUES (1504, 3, 3, 0, 2, 3, 76, 'fw1ngr60: Drop');

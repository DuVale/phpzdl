...
INSERT IGNORE INTO plugin_sid (plugin_id, sid, name, priority, reliability) VALUES (1615, 1, 'PaloAlto: TRAFFIC start', 1, 5);
INSERT IGNORE INTO plugin_sid (plugin_id, sid, name, priority, reliability) VALUES (1615, 2, 'PaloAlto: TRAFFIC end', 1, 5);
INSERT IGNORE INTO plugin_sid (plugin_id, sid, name, priority, reliability) VALUES (1615, 3, 'PaloAlto: TRAFFIC drop', 2, 5);
INSERT IGNORE INTO plugin_sid (plugin_id, sid, name, priority, reliability) VALUES (1615, 4, 'PaloAlto: TRAFFIC deny', 2, 5);

...
-- INSERT IGNORE INTO plugin_sid (plugin_id, sid, category_id, class_id, name, priority, reliability) VALUES (1561, 200, NULL, NULL, 'modsecurity: OK', 0, 1);
...
INSERT IGNORE INTO plugin_sid (plugin_id, sid, category_id, class_id, name, priority, reliability) VALUES (1561, 401, NULL, NULL, 'modsecurity: Authorization Required', 3, 1);

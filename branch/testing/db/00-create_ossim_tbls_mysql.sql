...
CREATE TABLE server (
	...
	remotepass		VARCHAR(128) NOT NULL,
	remoteurl		VARCHAR(128) NOT NULL,
	id              int(10) unsigned NULL,
	priority        smallint(5) unsigned NULL,	
    PRIMARY KEY     (name)
);
...
INSERT INTO action_type (_type, descr) VALUES ("ticket", "Open a ticket");
...
CREATE TABLE event (
	...
	rulename	TEXT,
	uuid		CHAR(36) ASCII,
 `rep_ip_src` varchar(64) NOT NULL,
 `rep_ip_dst` varchar(64) NOT NULL,
...
INSERT INTO incident_tag_descr VALUES(65001,'AlienVault_INTERNAL_PENDING','Vulnerability scanner pending tag - Prevents this event from being detected until tag is unset');
INSERT INTO incident_tag_descr VALUES(65002,'AlienVault_INTERNAL_FALSE_POSITIVE','Vulnerability scanner false positive tag - Prevents this event from being detected in the future');
...
(31, 'MENU', 'MenuIntelligence', 'CorrelationDirectives', 'Intelligence -> Correlation Directives', 1, 1, 1, '06.03'),
...
(48, 'MENU', 'MenuEvents', 'EventsForensics', 'Analysis -> Security Events', 1, 1, 1, '03.01'),
...
(51, 'MENU', 'MenuEvents', 'EventsRT', 'Analysis -> Security Events -> Real Time', 1, 0, 1, '03.03'),
...
(61, 'MENU', 'MenuEvents', 'ControlPanelSEM', 'Analysis -> Logs', 1, 0, 1, '03.04'),
...
(64, 'MENU', 'MenuPolicy', '5DSearch', 'Assets -> Asset Search', 1, 1, 1, '05.01'),
(65, 'MENU', 'MenuReports', 'ReportsReportServer', 'Reports -> Custom Reports', 0, 0, 1, '04.02'),
(66, 'MENU', 'MenuMonitors', 'MonitorsNetflows', 'Situational Awareness -> Network -> Traffic', 1, 1, 1, '07.01'),
...
(71, 'MENU', 'MenuEvents', 'EventsForensicsDelete', 'Analysis -> Security Events -> Delete Events', 0, 0, 1, '03.02'),
...
(74, 'MENU', 'MenuReports', 'ReportsCreateCustom', 'Reports -> Custom Reports -> Create Custom Report', 1, 1, 1, '04.06'),
...
(81, 'MENU', 'MenuMonitors', 'MonitorsInventory', 'Situational Awareness -> Inventory', 1, 1, 1, '07.04'),
(82, 'MENU', 'MenuEvents', 'EventsHidsConfig', 'Analysis -> Detection -> HIDS -> Config', 1, 0, 1, '03.12'),
(83, 'MENU', 'MenuMonitors', 'TrafficCapture', 'Situational Awareness -> Network -> Traffic Capture', 1, 0, 1, '07.02'),
(84, 'MENU', 'MenuMonitors', 'IPReputation', 'Situational Awareness -> IP Reputation', 0, 0, 1, '07.05');

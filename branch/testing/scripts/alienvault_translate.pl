...
# Get a valid google translation api key from google from
# http://code.google.com/intl/es-ES/apis/language/translate/v2/getting_started.html
...
sub check_key($){
    ...
    if($key eq "XXXXXX") {
        print "\nYou have to get a valid key:\n\n";
        print "http://code.google.com/intl/es-ES/apis/language/translate/v2/getting_started.html\n";
        print "\n\n";
        exit;
    }
}

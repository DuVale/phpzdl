...
$timing_template = ($argv[3] != "" && $argv[3] != "vulnscan") ? $argv[3] : "-T3";

$full = ($argv[4] == "full" || $argv[4] == "fast" || $argv[4] == "root") ? $argv[4] : "ping";
if ($full=="root") $full="full";
...
{
    $rscan = new RemoteScan($net, $full, $remote_sensor, $nmap_completed_scan);

...
void              sim_rule_prepend_src_inet                 (SimRule     *rule,
																												    SimInet     *inet);
void 						  sim_rule_prepend_src_inet_not            (SimRule     *rule,
                                                            SimInet     *src_inet);
void              sim_rule_remove_src_inet                 (SimRule     *rule,
																												    SimInet     *inet);
GList*            sim_rule_get_src_inets                   (SimRule     *rule);

void              sim_rule_prepend_dst_inet                 (SimRule     *rule,
																												    SimInet     *inet);
void 						  sim_rule_prepend_dst_inet_not            (SimRule     *rule,
                                                            SimInet     *dst_inet);

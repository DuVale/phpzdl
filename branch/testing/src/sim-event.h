...
#define SIM_PLUGIN_ID_TYPE_DIRECTIVE_EVENT  1505
#define SIM_PLUGIN_ID_TYPE_RDD_ANOMALY_EVENT  1508
#define SIM_PLUGIN_ID_SNORT_MIN  1001
#define SIM_PLUGIN_ID_SNORT_MAX  1500
...
#define __TYPEPOLICY__
  ...
  struct _SimEvent
  {
    ...
    /* HOME_NET boolean fields */
    gboolean  src_home_net_searched;
    gboolean  src_home_net;
    gboolean  dst_home_net_searched;
    ...
    gboolean is_prioritized; // deprecated
    SimRole *role;
    SimPolicy *policy;

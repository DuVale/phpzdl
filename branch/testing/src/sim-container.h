...
void              sim_container_db_load_plugins_ul              (SimContainer  *container,
								 SimDatabase   *database);
void              sim_container_add_plugin_ul                   (SimContainer  *container,
								 SimPlugin     *plugin);
GHashTable*       sim_container_get_plugins_ul                  (SimContainer  *container);
...
void              sim_container_db_load_plugins                 (SimContainer  *container,
								 SimDatabase   *database);
void              sim_container_add_plugin                      (SimContainer  *container,
								 SimPlugin     *plugin);
GHashTable*       sim_container_get_plugins                     (SimContainer  *container);
...
void              sim_container_db_load_plugin_sids_ul          (SimContainer  *container,
								 SimDatabase   *database);
void              sim_container_add_plugin_sid_ul               (SimContainer  *container,
								 SimPluginSid  *plugin_sid);
void              sim_container_remove_plugin_sid_ul            (SimContainer  *container,
								 SimPluginSid  *plugin_sid);
GHashTable*       sim_container_get_plugin_sids_ul              (SimContainer  *container);
...
void              sim_container_db_load_plugin_sids             (SimContainer  *container,
								 SimDatabase   *database);
void              sim_container_add_plugin_sid                  (SimContainer  *container,
								 SimPluginSid  *plugin_sid);
GHashTable*       sim_container_get_plugin_sids                 (SimContainer  *container);
...
void sim_container_increments_events_count (SimContainer * container);

GList*  sim_container_get_home_net(SimContainer *container);
void    sim_container_free_home_net(SimContainer *container);
